package com.liubin.virtualjoystick;
...
public class JoystickView1 extends View
        implements
        Runnable {
    ...
    */
     ...
     * JoystickView1's button is moved
     */
    public interface OnMoveListener {

        /**
         * Called when a JoystickView1's button has been moved
    ...
    /**
     * Interface definition for a callback to be invoked when a JoystickView1
     * is touched and held by multiple pointers.
     */
    public interface OnMultipleLongPressListener {
        /**
         * Called when a JoystickView1 has been touch and held enough time by multiple pointers.
         */
    ...
    */
    ...
    /**
     * Simple constructor to use when creating a JoystickView1 from code.
     * Call another constructor passing null to Attribute.
     * @param context The Context the JoystickView1 is running in, through which it can
    ...
    public JoystickView1(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs);
    }


    /**
     * Constructor that is called when inflating a JoystickView1 from XML. This is called
     * when a JoystickView1 is being constructed from an XML file, supplying attributes
     * that were specified in the XML file.
     * @param context The Context the JoystickView1 is running in, through which it can
     *        access the current theme, resources, etc.
     * @param attrs The attributes of the XML tag that is inflating the JoystickView1.
     */
    ...
    /**
     * Set the button color for this JoystickView1.
    ...
    /**
     * Set the border color for this JoystickView1.
    ...
    /**
     * Set the border alpha for this JoystickView1.
    ...
    /**
     * Set the background color for this JoystickView1.
    ...
    /**
     * Set the border width for this JoystickView1.
    ...
    /**
     * Register a callback to be invoked when this JoystickView1's button is moved
    ...
    /**
     * Register a callback to be invoked when this JoystickView1 is touch and held by multiple pointers
     * @param l The callback that will run
     */
